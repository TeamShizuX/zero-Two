...
from ZeroTwo.modules.play import generate_cover
from ZeroTwo.modules.play import arq
from ZeroTwo.modules.play import cb_admin_check
from ZeroTwo.modules.play import transcode
from ZeroTwo.modules.play import convert_seconds
from ZeroTwo.modules.play import time_to_seconds
from ZeroTwo.modules.play import changeImageSize
from ZeroTwo.config import BOT_NAME as bn
from ZeroTwo.config import DURATION_LIMIT
from ZeroTwo.config import UPDATES_CHANNEL as updateschannel
from ZeroTwo.config import que
from ZeroTwo.function.admins import admins as a
from ZeroTwo.helpers.errors import DurationLimitError
from ZeroTwo.helpers.decorators import errors
from ZeroTwo.helpers.admins import get_administrators
from ZeroTwo.helpers.channelmusic import get_chat_id
from ZeroTwo.helpers.decorators import authorized_users_only
from ZeroTwo.helpers.filters import command, other_filters
from ZeroTwo.helpers.gets import get_file_name
from ZeroTwo.services.callsmusic import callsmusic, queues
...
from ZeroTwo.services.downloaders import youtube

chat_id = None



@Client.on_message(filters.command(["cplaylist","cplaylist@Darlingg_02bot"]) & filters.group & ~filters.edited)
...
@Client.on_message(filters.command(["ccurrent","ccurrent@StreamMusic_Bot"]) & filters.group & ~filters.edited)
...
@Client.on_message(filters.command(["csettings","csettings@Darlingg_02bot"]) & filters.group & ~filters.edited)
...
@Client.on_message(filters.command(["cplay","cplay@StreamMusic_Bot"])  & filters.group & ~filters.edited)
@authorized_users_only
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name = "StreamMusic_Assistant"
    usar = user
    wew = usar.id
    try:
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                if message.chat.title.startswith("ZeroTwo: "):
                    await lel.edit(
                ...
                try:
                    ...
                    await lel.edit(
                        "<i><b>@Akatsuki_02_Assistant Joined Your Channel! 😌</b></i>",
                    )
                    ...
                    # print(e)
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 </b>\n<i><b>ZeroTwo Music Assistant (@Akatsuki_02_Assistant) can't join your Group,unban it first and try again 🥲",
                    )
    try:
        ...
        await lel.edit(
            f"<i>{user.first_name} Not In This Chat, Ask Admin To Send /play Command For First Time or add @Akatsuki_02_assistant Manually! 😶</i>"
        )
        return
