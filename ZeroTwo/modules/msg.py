import os
from ZeroTwo.config import SOURCE_CODE,ASSISTANT_NAME,PROJECT_NAME,SUPPORT_GROUP,UPDATES_CHANNEL

class Messages():
      START_MSG = f"😌 **Ohayo Darling**,\n\nI'm **{PROJECT_NAME}** 🎵\nI Can Play Music In Voice Chats of Telegeam Groups & Channels.Hit /help To Know How Stream Music 😉! \n\n**Made With Checkout @Project_Tsukiyomi"
      HELP_MSG = [
        ".",
f"""
Moshi Moshi 🌝! 
